...
//export class Transactions {
    ...
    // Client address (pubKey) and balance
    ...
    // Once block is mined, must update unspent transaction outputs
    ...
    export {
        ...
        UnspentTxOut, TxIn, TxOut, hasDuplicates, validateCoinbaseTx, validateTxIn, isValidTransactionStructure,
        Transaction, isValidTxOutStructure
    };
